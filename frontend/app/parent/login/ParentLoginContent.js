...
export default function ParentLoginContent() {
  ...
  const [signingInOAuth, setSigningInOAuth] = useState(false);
  const [signingInPin, setSigningInPin] = useState(false);
      ...
      <div style={{ maxWidth: 440, width: "100%" }} className="animate-in">
        ...
        <div className="card" style={{ marginBottom: 16 }}>
          ...
          <button
            ...
            disabled={signingInOAuth || signingInPin}
          ...
          >
            ...
            {signingInOAuth ? "ログイン中..." : "Google でログイン"}
          </button>
        </div>
          ...
          {loading ? (
            ...
            <form onSubmit={handlePinLogin}>
              ...
              <button
                ...
                disabled={!selectedUser || signingInOAuth || signingInPin}
                data-testid="pin-login-button"
              >
                {signingInPin ? "ログイン中..." : "ログイン"}
              </button>
            </form>
          )}
        </div>
